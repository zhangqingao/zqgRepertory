...
<div class="login-box">
  <div class="login-logo">
    <a href="#" style="color: white;font-family: Microsoft YaHei;"><b>添加企业用户</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body" style="background-color: rgba(54,167,129,.4); height: 400px;">
    <form action="<%=basePath%>/insertcomReg.shtml" method="post">
    <div class="form-group has-feedback">
         <input type="text" name="corpname" placeholder="&emsp;请输入公司名称" required="required" style="width: 320px;">
      ...
      <div><span style="color:red" id="erroMessage"></span></div>
       <div class="col-xs-4" style="width: 320px;margin-top: 1px">
          <button type="submit" class="btn btn-primary btn-block btn-flat" style="font-size: 16px;">添加</button>
        </div>
