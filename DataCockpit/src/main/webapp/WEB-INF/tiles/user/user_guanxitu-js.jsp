    ...
    var LinkView = joint.dia.LinkView.extend({
    	...
    	$(".choose").click(function(){
    		//移除画布
    		 //paper.remove();
    		//var guanxi=$(this).val();
    		var guanxiId=$(this).next().val();
    		//alert(guanxi1);
    		 $.ajax({
    			   type: "POST",
    			   url: "user_guanxitu1.shtml?id="+guanxiId,
    			   //data:"",
    			   success: function(message){
    	    		...
    	    		//定义形状
    	    		    ...
    	    		    //创建元素
    	    		    var start = state(100,100,"ellipse","#00FFFF", mess[0].name);
    	    		    //var state1 = state(300,200,"rect","#f7a07b", "认筹数据表");
    	    		    var state2 = state(400,100,"ellipse","#f7a07b", mess[1].name);
    	    		    

    	    		    //创建连线
    	    		 
    	    		    //link(start, state1, "");
    	    		    link(start, state2, "关联");
